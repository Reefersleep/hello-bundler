...
return cljs.core.reduce.call(null,(function (result,p__9952){
...
var vec__9956 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__9956,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__9956,(1),null);
var ab = cljs.core.nth.call(null,vec__9956,(2),null);
...
return clojure$data$EqualityPartition$equality_partition$dyn_9962.call(null,x);
}
});
...
return clojure$data$Diff$diff_similar$dyn_9963.call(null,a,b);
}
});
...
return (function (){var G__9967 = clojure.data.equality_partition.call(null,a);
var G__9967__$1 = (((G__9967 instanceof cljs.core.Keyword))?G__9967.fqn:null);
switch (G__9967__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9967__$1)].join('')));
