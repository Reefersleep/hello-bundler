...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11107){
...
if(cljs.core.truth_((function (){var or__4120__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
if(or__4120__auto__){
...
return cljs.core._write.call(null,writer__4364__auto__,"devtools.formatters.printing/TemplateWriter");
}));
...
if(cljs.core.truth_(((cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group)))?(function (){var or__4120__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11113_SHARP_){
return (!((cljs.core.meta.call(null,p1__11113_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__11114__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11118){var _e__10738__auto__ = e11118;
return false;
}})();
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
...
}catch (e11120){var _e__10738__auto__ = e11120;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11122 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11123 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11123);

try{var map__11124 = opts;
...
var markup_db = cljs.core.get.call(null,map__11124__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11122);
}});
...
var temp__5733__auto___11129 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___11129)){
var managed_print_level_11130 = temp__5733__auto___11129;
var _STAR_print_level_STAR__orig_val__11127_11131 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11128_11132 = managed_print_level_11130;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11128_11132);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__11126_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__11126_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11127_11131);
}} else {
job_fn.call(null);
}
