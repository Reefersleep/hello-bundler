...
var seq__1714_1718 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__1715_1719 = null;
var count__1716_1720 = (0);
var i__1717_1721 = (0);
while(true){
if((i__1717_1721 < count__1716_1720)){
var str_1722 = cljs.core._nth.call(null,chunk__1715_1719,i__1717_1721);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1722})));


var G__1723 = seq__1714_1718;
var G__1724 = chunk__1715_1719;
var G__1725 = count__1716_1720;
var G__1726 = (i__1717_1721 + (1));
seq__1714_1718 = G__1723;
chunk__1715_1719 = G__1724;
count__1716_1720 = G__1725;
i__1717_1721 = G__1726;
continue;
} else {
var temp__5735__auto___1727 = cljs.core.seq.call(null,seq__1714_1718);
if(temp__5735__auto___1727){
var seq__1714_1728__$1 = temp__5735__auto___1727;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__1714_1728__$1)){
var c__4550__auto___1729 = cljs.core.chunk_first.call(null,seq__1714_1728__$1);
var G__1730 = cljs.core.chunk_rest.call(null,seq__1714_1728__$1);
var G__1731 = c__4550__auto___1729;
var G__1732 = cljs.core.count.call(null,c__4550__auto___1729);
var G__1733 = (0);
seq__1714_1718 = G__1730;
chunk__1715_1719 = G__1731;
count__1716_1720 = G__1732;
i__1717_1721 = G__1733;
continue;
} else {
var str_1734 = cljs.core.first.call(null,seq__1714_1728__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_1734})));


var G__1735 = cljs.core.next.call(null,seq__1714_1728__$1);
var G__1736 = null;
var G__1737 = (0);
var G__1738 = (0);
seq__1714_1718 = G__1735;
chunk__1715_1719 = G__1736;
count__1716_1720 = G__1737;
i__1717_1721 = G__1738;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__1743 = script;
goog.object.set(G__1743,"type","text/javascript");

goog.object.set(G__1743,"onload",onload);

goog.object.set(G__1743,"onreadystatechange",onload);

return G__1743;
})();
if((opt_sourceText == null)){
var G__1744 = script__$1;
goog.object.set(G__1744,"src",src);

return G__1744;
} else {
var G__1745 = script__$1;
goog.dom.setTextContent(G__1745,opt_sourceText);
...
var path_1746 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_1746);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1746)].join(''));
} else {
var path_1747 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_1747);

goog.object.remove(goog.dependencies_.written,path_1747);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_1747)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__1748 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__1749 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__1749);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__1748);
}})()})));
}));
